        ...
        <div className="bg-white border border-brand-border rounded shadow-sm overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-6">
              ...
              <h1 className="text-xl font-extrabold text-brand-dark mt-3">Welcome Back</h1>
              <p className="text-sm text-brand-gray mt-1">Please sign in to your account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="text-xs font-extrabold text-brand-gray uppercase tracking-wider">Password</label>
        ...
        <div className="flex items-center justify-center gap-6 mt-6 text-xs text-brand-gray">
          {["100% Secure", "No Spam", "Easy Returns"].map((t) => (
            <span key={t} className="flex items-center gap-1">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#ff3f6c" strokeWidth="2.5">
