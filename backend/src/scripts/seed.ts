...
async function seedCategoriesAndProducts(): Promise<void> {
  ...
  const categories = await prisma.category.findMany({
    where: {
      slug: { in: ["electronics", "bags", "beauty"] },
    },
  });
  ...
  await prisma.subCategory.createMany({
    data: [
      { name: "Mobiles", description: "Smartphones", categoryId: categoryMap["electronics"] },
      { name: "Cameras", description: "Digital and mirrorless cameras", categoryId: categoryMap["electronics"] },
      { name: "TVs", description: "Smart televisions", categoryId: categoryMap["electronics"] },
      { name: "Audio", description: "Earphones and headphones", categoryId: categoryMap["electronics"] },
      { name: "Women's Bags", description: "Handbags and purses", categoryId: categoryMap["bags"] },
      { name: "Perfumes", description: "Men and women fragrances", categoryId: categoryMap["beauty"] },
      { name: "Skincare", description: "Face oils, lotions and more", categoryId: categoryMap["beauty"] },
    ],
    skipDuplicates: true,
  });
  ...
  const subCategoryMap: Record<string, number> = Object.fromEntries(
    ...
    data: [
      {
        ...
        status: "ACTIVE",
        isFeatured: true,
        subCategoryId: subCategoryMap["Mobiles"],
      },
      {
      ...
      },
      {
        ...
        status: "ACTIVE",
        isFeatured: true,
        subCategoryId: subCategoryMap["TVs"],
      },
      {
        ...
        status: "ACTIVE",
        isFeatured: true,
        subCategoryId: subCategoryMap["Audio"],
      },
      {
        ...
        status: "ACTIVE",
        isFeatured: true,
        subCategoryId: subCategoryMap["Women's Bags"],
      },
      {
      ...
      },
      {
        ...
        status: "ACTIVE",
        isFeatured: false,
        subCategoryId: subCategoryMap["Perfumes"],
      },
      {
      ...
      },
      {
        ...
        status: "ACTIVE",
        isFeatured: false,
        subCategoryId: subCategoryMap["Skincare"],
      },
      {
