        ...
        <div className="px-6 py-4 border-b border-brand-border">
          ...
          <div className="space-y-2.5">
            {[
              ...
              {
                step: "2",
                text: "Our team will process your order within 24 hours",
                done: true,
              },
              {
                step: "3",
                text: "You'll get a tracking link once shipped",
                done: false,
              },
              {
                step: "4",
                text: `Estimated delivery by ${estimatedDelivery()}`,
                done: false,
              },
            ].map((s) => (
              <div key={s.step} className="flex items-start gap-3">
                <div
                  className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 text-[10px] font-extrabold ${s.done ? "bg-primary text-white" : "bg-brand-border text-brand-gray"}`}
                >
                  {s.done ? (
                    <svg
                      width="10"
