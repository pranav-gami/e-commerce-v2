!(function (t, e) {
	...
	r.prototype = {
		...
		on: function (t, e) {
			return (
				(this._listeners = this._listeners || {}), (this._listeners[t] = this._listeners[t] || []).push(e), this
			);
		},
	...
	a.prototype = {
		...
		removeValidator: function (t) {
			return (
				this.validators[t] || d.warn('Validator "' + t + '" is not defined.'), delete this.validators[t], this
			);
		},
		...
		(v.Field = {
			...
			getErrorsMessages: function () {
				...
				for (var t = [], e = 0; e < this.validationResult.length; e++)
					t.push(
						this.validationResult[e].errorMessage || this._getErrorMessage(this.validationResult[e].assert)
					);
				return t;
			},
		...
		_submit: function (t) {
			if (!1 !== this._trigger('submit')) {
				if (t) {
					...
					0 === e.length &&
						(e = h('<input class="parsley-synthetic-submit-button" type="hidden">').appendTo(
							this.$element
						)),
	...
	A.prototype = {
			...
			(this.options.multiple = this.options.multiple.replace(/(:|\.|\[|\]|\{|\}|\$)/g, '')),
				t &&
					h('input[name="' + t + '"]').each(function (t, e) {
						var i = d.getType(e);
						('radio' !== i && 'checkbox' !== i) ||
							e.setAttribute(r.options.namespace + 'multiple', r.options.multiple);
					});
		...
		bind: function (t, e) {
			...
			switch (t) {
				case 'parsleyForm':
					i = h
						.extend(new y(this.element, this.domOptions, this.options), new r(), window.ParsleyExtend)
						._bindFields();
					break;
				case 'parsleyField':
					i = h.extend(
			...
			return (
				this.options.multiple &&
					d.setAttr(this.element, this.options.namespace, 'multiple', this.options.multiple),
				void 0 !== e
			...
			l(this, {
				...
				install: function () {
					if (!n.inputEventPatched) {
						...
						for (
							var t = 0,
								e = ['select', 'input[type="checkbox"]', 'input[type="radio"]', 'input[type="file"]'];
							t < e.length;
							t++
						) {
							var i = e[t];
